    ...
    public class EmpleadoDAC : DataAccessComponent, IRepository<Empleado>
    {
        public Empleado Create(Empleado entity)
        {
            ...
            using (DbCommand cmd = db.GetSqlStringCommand(SQL_STATEMENT))
            {
                ...
                db.AddInParameter(cmd, "@ID_departamento", DbType.Int64, entity.departamento.Id);
        ...
        public Empleado ReadBy(Empleado entity)
        {
            ...
            using (DbCommand cmd = db.GetSqlStringCommand(SQL_STATEMENT))
            {
                db.AddInParameter(cmd, "@Id", DbType.String, entity.cuil);
                using (IDataReader dr = db.ExecuteReader(cmd))
                {
                    if (dr.Read())
                    {
        ...
        public void Update(Empleado entity)
        {
            ...
            using (DbCommand cmd = db.GetSqlStringCommand(SQL_STATEMENT))
            {
                ...
                db.AddInParameter(cmd, "@ID_departamento", DbType.Int32, entity.departamento.Id);
                db.AddInParameter(cmd, "@ID_division", DbType.Int32, entity.division.Id);
